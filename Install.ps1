...
Install "Microsoft Service Fabric Runtime 5.1.163.9590" "Installing Microsoft Service Fabric" 'Start-Process -FilePath msiexec.exe -ArgumentList "/i http://download.microsoft.com/download/C/9/6/C9680A4C-291F-4A6F-B699-26FF704577BA/MicrosoftServiceFabric.5.1.163.9590.msi /passive /norestart" -wait'

Install "Microsoft Service Fabric SDK 2.1.163" "Installing Service Fabric SDK" 'Start-Process -FilePath msiexec.exe -ArgumentList "/i http://download.microsoft.com/download/C/9/6/C9680A4C-291F-4A6F-B699-26FF704577BA/MicrosoftServiceFabricSDK.2.1.163.msi /passive /norestart" -wait'
